  ...
  return (
    <div>
        ...
        <div className="gallery-option">
          <div className="gallOpt" id="all">All</div>
          <div className="gallOpt" id="locations">Locations</div>
          <div className="gallOpt" id="projects">Projects</div>
          <div className="gallOpt" id="random">Random</div>
        </div>
